  ...
  return (
    <AdminShell>
      ...
      <section className={styles.columns}>
        ...
        <div className={styles.panel}>
          <div className={styles.panelHeading}><div><small>Customer conversations</small><h2>Recent enquiries</h2></div><Link href="/admin/custom-moorti">Open requests <ArrowUpRight size={15} /></Link></div>
