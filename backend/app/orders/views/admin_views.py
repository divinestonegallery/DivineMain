...
class AdminOrderDetailView(AdminAPIView):
    @extend_schema(operation_id='admin_order_detail_retrieve')
    ...
    @extend_schema(operation_id='admin_order_detail_update')
    ...
    @extend_schema(operation_id='admin_order_detail_replace')
    def put(self, request, uid):
        return self.patch(request, uid)
