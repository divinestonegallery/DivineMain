...
class CustomerOrderListCreateView(AuthenticatedAPIView):
    @extend_schema(operation_id='v1_orders_list')
    ...
    @extend_schema(operation_id='v1_orders_create')
...
class CustomerOrderDetailView(AuthenticatedAPIView):
    @extend_schema(operation_id='v1_order_detail_retrieve')
...
class CustomerOrderCancelView(AuthenticatedAPIView):
    @extend_schema(operation_id='v1_order_cancel')
...
class PaymentVerifyView(AuthenticatedAPIView):
    @extend_schema(operation_id='v1_order_payment_verify')
    def post(self, request):
